      ...
      <div className="flex flex-col lg:flex-row items-center">
        <div className="flex flex-col items-center justify-center p-10 space-y-4 w-full">
          ...
          <h2 className="text-5xl font-semibold text-center lg:text-left mb-4">
            Store <span className="text-blue-900">everything</span> all in one
            place.
          </h2>
          ...
          <Link
            href="/dashboard"
            className="bg-blue-900 py-4 px-8 rounded-2xl cursor-pointer self-center lg:self-start text-white"
          >
            Get Started
          </Link>
        </div>
